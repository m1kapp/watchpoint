  ...
  return (
    <>
      ...
      <div className="px-4 pb-6">
        ...
        {/* 유튜브 하이라이트 — 경기 종료(score 존재) 시에만 */}
        {m.score && (
          <a
            href={`https://www.youtube.com/results?search_query=${encodeURIComponent(
              `${m.home} ${m.away} ${m.stage} 하이라이트`
            )}`}
            target="_blank"
            rel="noopener noreferrer"
            className="mt-3 flex items-center justify-center gap-2 py-3.5 rounded-2xl bg-white dark:bg-zinc-900 active:bg-zinc-50 dark:active:bg-zinc-800/50 transition-colors"
            style={{ boxShadow: CARD_SHADOW }}
          >
            ...
            <span className="text-[13px] font-bold text-red-500">경기 하이라이트 보기</span>
